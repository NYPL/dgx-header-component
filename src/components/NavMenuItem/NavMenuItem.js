...
class NavMenuItem extends React.Component {
    ...
    render() {
        ...
        let linkClass = cx({
                'active': this.props.index === this.state.activeItem || HeaderStore._getLastActiveMenuItem() === this.props.navId
            }),
        ...
        return ( < li id = {
            ...
            id = {
                (this.props.navId) ? 'NavMenuItem-Link-' + this.props.navId : 'NavMenuItem-Link'
            } >
            < a href = {
                target
            }
            ...
            onClick = {
                utils._trackHeader.bind(this, 'Go to...', `${this.props.label['en'].text}`)
            } > {
