  ...
  _createClass(SearchButton, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2['default'])({
        'active': _storesStoreJs2['default']._getSearchButtonActionValue() === 'hoverSearch' || _storesStoreJs2['default']._getLastActiveMenuItem() === 'hoverSearch'
      });
    ...
    value: function _activateHover() {
      this.hoverTimer = setTimeout(function () {
        ...
        _utilsGaUtilsJs2['default']._trackEvent('Search', 'Open Menu');
      }, 150);
    }
  }, {
