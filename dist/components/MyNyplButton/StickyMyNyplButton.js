...
var StickyMyNyplButton = (function (_React$Component) {
  function StickyMyNyplButton(props) {
    ...
    this.state = {
      myNyplVisible: _storesStoreJs2['default']._getStickyMyNyplVisible(),
  ...
  _createClass(StickyMyNyplButton, [{
    ...
    value: function _handleClick(e) {
      ...
      if (this.state.target === '#') {
        ...
        _utilsGaUtilsJs2['default']._trackEvent('Log In', 'StickyMyNyplButton - ' + visibleState);
      }
    }
  }, {
    ...
    value: function _handleOnClickOut(e) {
      if (_storesStoreJs2['default']._getStickyMyNyplVisible()) {
        _actionsActionsJs2['default'].toggleStickyMyNyplVisible(false);
        _utilsGaUtilsJs2['default']._trackEvent('Log In', 'StickyMyNyplButton - Closed');
      }
    }
  }, {
    key: '_onChange',
    ...
    value: function _onChange() {
      this.setState({ myNyplVisible: _storesStoreJs2['default']._getStickyMyNyplVisible() });
    }
  }]);
