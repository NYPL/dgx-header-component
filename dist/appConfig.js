...
var config = {
  ...
  loginMyNyplLinks: {
    catalog: "".concat(authServerDomain, "/login?redirect_uri=https://browse.nypl.org/iii/encore/myaccount"),
    research: "".concat(authServerDomain, "/login?redirect_uri=https://catalog.nypl.org/patroninfo/top"),
    tokenRefreshLink: "".concat(authServerDomain, "/refresh"),
    logOutLink: "".concat(authServerDomain, "/logout")
  },
  myNyplLinks: {
