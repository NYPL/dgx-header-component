  ...
  _createClass(EmailSubscription, [{
    ...
    value: function render() {
      ...
      if (!isLoading) {
        ...
        if (status === 'success') {
          _utilsGaUtilsJs2['default']._trackEvent('Subscribe', 'Success');
          subscribeContent = _react2['default'].createElement(
            'div',
            null,
        ...
        if (status === 'exists') {
          _utilsGaUtilsJs2['default']._trackEvent('Subscribe', 'Error -- already subscribed');
          subscribeContent = _react2['default'].createElement(
            'div',
            null,
        ...
        if (status === 'error' || status === 'Internal Server Error') {
          _utilsGaUtilsJs2['default']._trackEvent('Subscribe', 'Error');
          subscribeContent = _react2['default'].createElement(
            'div',
