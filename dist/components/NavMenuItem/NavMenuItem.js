...
var NavMenuItem = function (_React$Component) {
  ...
  _createClass(NavMenuItem, [{
    ...
    value: function render() {
      ...
      var megaMenuArrow = this.props.subNav && this.props.features && cookie !== '1' ? _react2.default.createElement(_MegaMenuArrow2.default, {
        navId: this.props.navId,
        index: this.props.index,
        currentActiveItem: this.state.activeItem
      }) : null;
      var megaMenu = this.props.subNav && this.props.features && cookie !== '1' ? _react2.default.createElement(_MegaMenu2.default, {
